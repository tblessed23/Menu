...
public class TrailersUtils {
    private static final String LOG_TAG = TrailersUtils.class.getSimpleName();

    /**
     * Query the themoviedb.org dataset and return a list of {@link Trailers} objects.
     */
    public static List<Trailers> fetchTrailerData(String requestUrl) {
        ...
        List<Trailers> Trailers = extractTrailers(jsonResponse);
    ...
    /**
     * Return a list of {@link Trailers} objects that has been built up from
     * parsing a JSON response.
     */
    public static List<Trailers> extractTrailers(String TrailersJSON) {
        ...
        try {
            ...
            JSONObject root = new JSONObject(TrailersJSON);
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                String site = currentMovie.getString("site");
                String type = currentMovie.getString("type");


                Trailers newmovie = new Trailers(key, site, type);
                Trailers.add(newmovie);
            ...
            Log.e("TrailersUtils", "Problem parsing the news JSON results", e);
        }
